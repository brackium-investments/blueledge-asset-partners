...
export const privacyData = [
  {
    title: "WHO WE ARE",
    texts: [
      "Blueledge asset partners Limited is a company registered in the United Kingdom for Crypto forex and many more types of investments. Blueledge asset partners Limited is the controls and is responsible for the data of its Client disclosed, to register for a investments Account and/or to make use of any other services offered by the Blueledge asset partners Limited through the (hereinafter “Website”) (this term shall at all times include Website’s desktop and mobile versions). Blueledge asset partners Limited exercises control over the processing of data in undertakings affiliated to it and which belong to the Blueledge asset partners Limited Group of companies.",
      "This Privacy Policy addresses the privacy issues of the Blueledge asset partners Limited Group so when we mention “Blueledge asset partners Limited”, “Company”, “we”, “us” or “our” in this Privacy Policy, we are referring to the relevant company in Blueledge asset partners Limited responsible for collecting and/or processing your data when you use the investments Platform through the Website, either for a investments Account or more(or their mobile/desktop versions) (hereinafter the Service(s)). In Blueledge asset partners LTD, we respect your privacy and therefore all companies within the Blueledge asset partners LTD is committed to protect your data, which it collects, uses and/or has access to.",
      ...
      "The Company shall not divulge any private information of its Clients and former Clients unless the Client approves in writing such disclosure or unless such disclosure is required under applicable law or is required in order to verify the Client’s identity or it is required for Blueledge asset partners LTD to perform its contractual obligations under any agreement concluded with the Client. The Clients’ information is processed only by the employees of the Company and/or employees of the Premium Trade limited group and/or trusted third parties which provide specific support services, dealing with the specific Client’s Accounts and necessary for the provision of our services. All such information shall be stored on electronic and physical storage media according to applicable law here in the United state of America.",
    ],
  },
  {
    title: "DATA USAGE",
    ...
    texts: [
      ...
      "Transaction Data includes details about the transactions performed by you, details about payments, withdrawals, exchanges, investments history, profit, balance, deposited and withdrawal amount methods, and any other details in relation to the services you have made use of through our Website.",
      ...
      "Usage Data includes information about how you use the Website, products and services, registration date, account category, investments cluster, number of complaints, number of requests filed and IP history.",
      ...
      "Conformity Data includes details about your education, employment status, investments experience, self-assessment test.",
...
const Privacy = () => {
  return (
    <div className="flex flex-col">
      ...
      <p>
        Blueledge asset partners respects your privacy and is committed to
