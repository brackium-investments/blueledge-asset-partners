  ...
  return (
    <div className="flex flex-col mt-[5rem]">
      ...
      <p>
        ...
        relationship between Creststone Investments and the user (a natural or
        legal entity) (hereinafter referred to as the “Client”) of
        www.Creststone.com (hereinafter referred as the “Website”).
      </p>
